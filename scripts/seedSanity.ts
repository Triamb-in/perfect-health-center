...
async function seed() {
  ...
  const clinicSettingsDoc = {
    ...
    secondaryPhone: defaultClinicData.contact.secondaryPhoneFormatted,
    secondaryEmail: defaultClinicData.contact.secondaryEmail,
    secondaryContactName: defaultClinicData.contact.secondaryContactName,
